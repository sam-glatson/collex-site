...
const AboutUs = () => {
    return (
        <section className="mt-[130px] px-5 font-DMSans sm:px-[56px] min-[2000px]:px-[140px]">
            <div className="grid grid-cols-1 items-center space-y-5 lg:grid-cols-2 lg:space-y-0">
                ...
                <div className="pl-7">
                    <h6 className="flex items-center text-lg leading-[22px] text-manatee-500 before:mr-2.5 before:h-3 before:w-3 before:rounded-full before:bg-cornflower-lilac-500 before:content-['']">
                        About Company
                    </h6>
                    <h2 className="mt-3 text-3xl font-bold text-shark-500 2xl:text-[60px] 2xl:leading-[72px]">
            ...
            <div className="mt-[130px] grid grid-cols-1 items-center justify-items-center min-[425px]:grid-cols-2 min-[425px]:justify-items-start md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 2xl:space-x-[100px]">
