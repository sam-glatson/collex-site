...
const Banner = () => {
    return (
        <section className="flex flex-col font-DMSans">
            ...
            <div className="px-5 sm:px-14 lg:px-6 xl:px-14 min-[2000px]:px-[140px]">
                <div className="grid grid-cols-1 items-center space-y-2.5 lg:grid-cols-2 lg:space-y-0">
                    <div className="text-center lg:text-left">
                        <h1 className="text-5xl font-bold text-shark-500 sm:text-[85px] 2xl:text-[125px] 2xl:leading-[138px]">
                            Global...
                            <br /> Solution
                        </h1>
                        ...
                        <div className="mt-10 flex flex-row items-center justify-center max-[380px]:flex-col max-[380px]:space-y-2.5 min-[380px]:space-x-5 lg:justify-normal">
                            ...
                            >
                                <div className="relative flex items-center space-x-4 before:absolute before:bottom-0 before:h-[3px] before:w-full before:bg-cornflower-lilac-500 before:content-['']">
                                    <span className="text-lg font-bold leading-[70px]">About Collax</span>
                                    <div>
                                        <RightArrowIcon />
                                    </div>
                                </div>
                            ...
                            <div className="relative">
                                <div className="flex h-[70px] w-[70px] cursor-pointer items-center justify-center rounded-full border border-abbey-500 border-opacity-20 p-5 before:absolute  before:top-[1px] before:h-[69px] before:w-[69px] before:rounded-[35px] before:border-[3px] before:border-b-portage-500 before:border-l-transparent before:border-r-transparent before:border-t-transparent before:content-['']">
                                    <PlayIcon />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="relative">
                        ...
                        <Image
                            src={PuzzleImage}
                            alt="puzzle-image"
                            className="absolute -bottom-2.5 right-12 w-[120px] animate-bounce object-cover min-[530px]:bottom-2.5 min-[530px]:right-[90px] min-[530px]:w-[189px] md:bottom-[70px] md:right-[160px] lg:bottom-4 lg:right-[35px] lg:w-[120px] xl:right-[65px]  xl:w-[160px] 2xl:bottom-[20px] 2xl:right-[90px] 2xl:w-[189px] min-[2200px]:bottom-[120px] min-[2200px]:right-[250px]"
                        />
                    </div>
                </div>
                <SocialShare />
