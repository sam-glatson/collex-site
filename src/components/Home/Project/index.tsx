...
const Project = () => {
    ...
    return (
        <section
            className="px-4 py-5 font-DMSans sm:mt-10 sm:px-14 lg:mt-120 lg:px-6 2xl:px-14 min-[1900px]:px-120"
            id="contact"
        >
            <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2 md:items-center md:gap-7.5 min-[2000px]:grid-cols-3">
