...
const Specification = () => {
    return (
        <section className="px-4 py-5 font-DMSans sm:px-[56px] lg:px-6 2xl:px-[56px] min-[1900px]:px-[120px]">
            <div className="my-10 grid grid-cols-1 items-center justify-items-center space-y-5 lg:grid-cols-2 lg:justify-items-start lg:space-y-0">
                ...
                <div className="sm:pl-5">
                    ...
                    <p className="pt-4 text-lg leading-[30px] text-manatee-500 sm:pt-10">
