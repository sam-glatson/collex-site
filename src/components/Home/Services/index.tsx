        ...
        >
            <div className="px-5 font-DMSans sm:px-14 2xl:px-130 min-[2000px]:px-140">
                ...
                <div className="mt-4 flex flex-col items-center justify-between space-y-4 md:flex-row md:space-y-0">
                    <h2 className="text-3xl font-bold sm:text-17xl lg:leading-72">What we do</h2>
                    <button
                ...
                <div className="mt-10 grid gap-7.5 sm:mt-14 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
