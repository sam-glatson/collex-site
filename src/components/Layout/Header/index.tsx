...
const Header = () => {
    return (
        <header className="fixed z-0 hidden h-[1080px] max-w-xs bg-shark-500 py-[45px] pl-[25px] pr-[25px] font-DMSans sm:block lg:pl-[55px] lg:pr-[35px]">
            <div className="space-y-[100px]">
                ...
                <div className="space-y-[13px]">
                    ...
                    <p className="text-[20px] font-semibold leading-[64px] text-white">infocollax.com</p>
                </div>
            </div>
        </header>
    );
