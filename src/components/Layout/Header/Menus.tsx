        ...
        <div className="relative flex">
            ...
            <ul className="header-menu-list space-y-10">
                <li onClick={() => handelMenu(1)} className={`${menu == 1 ? " text-apache-500" : "text-manatee-500"}`}>
                    Home
                    {menu == 1 ? (
                        <div className="absolute -left-[2px] top-0 h-8 w-[2px] rounded-[20px] bg-apache-500"></div>
                    ) : null}
                </li>
                ...
                <li onClick={() => handelMenu(5)} className={`${menu == 5 ? " text-apache-500" : "text-manatee-500"}`}>
                    Contact
                    {menu == 5 ? (
                        <div className="absolute -left-[2px] bottom-0 h-8 w-[2px] rounded-[20px] bg-apache-500"></div>
                    ) : null}
                </li>
            </ul>
        </div>
